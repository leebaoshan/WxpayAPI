...
require_once "WxPay.Mchpay.Data.php";
...
class WxPayApi
{
	...
	/**
	 * 
	 * 企业付款，mchpay中partner_trade_no、desc、amount必填
	 * appid不需要填入
	 * @param WxPayConfigInterface $config  配置对象
	 * @param WxPayMchpay $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	public static function mchpay($config, $inputObj, $timeOut = 10){
	...
	{		
		...
		$https = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && $_SERVER['HTTPS'] != 'off') ? 1 : 0;
		if ($https) {
